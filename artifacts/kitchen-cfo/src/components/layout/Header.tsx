        ...
        <div className="flex items-center gap-2">
          {isDemo && (
            <button
              ...
              className="flex items-center gap-1.5 bg-amber-100 text-amber-800 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:hover:bg-amber-900/50 px-3 py-2 rounded-full text-xs font-semibold transition-colors min-h-[36px]"
            >
